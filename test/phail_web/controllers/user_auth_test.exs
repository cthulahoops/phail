defmodule PhailWeb.UserAuthTest do
  use PhailWeb.ConnCase, async: true

  alias Phail.Accounts
  alias PhailWeb.UserAuth
  import Phail.AccountsFixtures

  @remember_me_cookie "_phail_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PhailWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      PhailWeb.Endpoint.subscribe(live_socket_id)
