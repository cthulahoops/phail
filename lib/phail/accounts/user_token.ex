defmodule Phail.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  ...
  def build_session_token(user) do
    ...
    {token, %Phail.Accounts.UserToken{token: token, context: "session", user_id: user.id}}
  end
  ...
  def token_and_context_query(token, context) do
    from Phail.Accounts.UserToken, where: [token: ^token, context: ^context]
  end
